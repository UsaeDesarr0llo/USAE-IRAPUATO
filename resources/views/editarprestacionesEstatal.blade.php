...
<div class="py-12">
    <div class="max-w-7x1 mx-auto sm:px-6 lg:px-8">
        ...
        <form action="{{ route('actualize', $date->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('POST')
          ...
          <div class="bg-white px-4 py-5 sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              <div class="col-span-6 sm:col-span-3">
                ...
                <input value="{{$date->nombre}}" class="form-control" type="text" name="nombre" id="nombre" readonly>  
            </div>

              <div class="col-span-6 sm:col-span-3">
                <label for="last-name" class="block text-sm font-medium text-gray-700">Adjuntar Nuevo PDF</label>
                <input value="{{$date->pdf}}" name="pdf" id="pdf" type="file" class="form-control">
              </div>
            </div>
          </div>

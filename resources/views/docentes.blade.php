        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  @foreach ($pdfDoc2 as $dire1)
                  <a role="button" target="_blank" class="btn btn-primary" href="Archivos/{{$dire1->imagen}}" target="_self">Ver</a>
                  @endforeach
                </div>
                <small class="text-muted"></small>
              </div>
